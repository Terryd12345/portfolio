    ...
    return (
        <section id="whyme" className="whyme">
            <div className="whyme__content">
                ...
                <br/>
                <p className="whyme--description">
                    Leveraging my <b>experience and indepth training</b> in the field of software development. <b>I provide my clients with the understanding needed for them to make the right decisions for their business</b>. I utilise both off the shelve solutions as well as custom solutions tailored to the client's budget and specific needs.
                </p>
            </div>
        </section>
    )
